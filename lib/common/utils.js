 ...
 */
module.exports.variableFrameLookup = function(name, first) {
 ...
 */
module.exports.blockFrameLookup = function(depth) {
 ...
 */
module.exports.lookupProperty = function(name){
  try {
...
module.exports.hashToObject = function(hash) {
  var object = {};
