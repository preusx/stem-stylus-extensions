/**
 * Convert unit from one unit type to another.
 * ======================================================================== */
...
var plugin = function(style){
   ...
   */
  var toUnit = function(length, to, from_context, to_context) {
  ...
  for(var i = convertableUnits.length - 1; i >= 0; i--) {
    style.define('to-' + convertableUnits[i], (function(to) {
      var fnc;
